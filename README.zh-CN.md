...
- MZ 仅接受未部署、未加密且核心脚本版本严格为 1.10.0 的编辑器源工程。
- 系统会自动识别工程标记、核心脚本、数据布局、图块尺寸和画布尺寸；MV/MZ 文件混用、部署目录、加密资源或其他 MZ 核心版本会在写入前被拒绝。
...
1. 准备一个可正常打开的 RPG Maker MV 项目，或未部署、未加密的 RPG Maker MZ 1.10.0 源工程。
...
- Node.js 22.5 或更高版本
- npm
- 一个真实的 RPG Maker MV 项目或受支持的 RPG Maker MZ 1.10.0 源工程
