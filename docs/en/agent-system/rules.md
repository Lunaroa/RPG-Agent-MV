...
Game-project rules describe the specific RPG Maker MV or supported MZ project. They can define naming, story, switch and variable conventions, plugin usage, or content language. The Agent should read them before editing that project.
