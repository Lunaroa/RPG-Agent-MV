...
A skill should describe when it applies, what files or project facts it needs, and what boundaries it must respect. It should not replace product rules or invent a write path that bypasses validation and direct-save review.
