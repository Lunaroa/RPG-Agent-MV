...
contextBridge.exposeInMainWorld('api', {
  ...
  uiDesigner: {
    ...
    inspectSceneDeletion: (request: Pick<UiDesignerSceneDeleteRequest, 'path' | 'project'>) => ipcRenderer.invoke('ui-designer:scene-delete:inspect', request),
    deleteScene: (request: UiDesignerSceneDeleteRequest) => ipcRenderer.invoke('ui-designer:scene-delete:execute', request),
    ...
    readGlobalData: (request?: UiDesignerGlobalDataRequest) => ipcRenderer.invoke('ui-designer:global-data:read', request),
    saveGlobalData: (request: UiDesignerGlobalDataRequest, data: unknown) => ipcRenderer.invoke('ui-designer:global-data:save', request, data),
  ...
  particlePreview: {
    prepare: (animation: unknown, autoplay: boolean, project?: string, armed?: boolean, loop?: boolean) => ipcRenderer.invoke('particlePreview:prepare', animation, autoplay, project, armed, loop),
