  ...
  <el-dialog :model-value="props.modelValue" :title="t('settings')" width="min(620px, 92vw)" destroy-on-close @update:model-value="close">
    <div class="dialog-stack">
      <el-form label-position="top">
        ...
        <el-form-item :label="t('mapBackground')"><div class="inline-fields"><el-input-number :model-value="designer.document.canvas.mapBackground.mapId" :min="0" @change="designer.setMapBackground('mapId', Number($event ?? 0))" /><el-input-number :model-value="designer.document.canvas.mapBackground.blur" :min="0" @change="designer.setMapBackground('blur', Number($event ?? 0))" /><UiNamedEntryField kind="switch" allow-none :model-value="designer.document.canvas.mapBackground.switchId" ui-id="ui-designer-settings-map-switch" @update:model-value="designer.setMapBackground('switchId', $event)" /></div></el-form-item>
