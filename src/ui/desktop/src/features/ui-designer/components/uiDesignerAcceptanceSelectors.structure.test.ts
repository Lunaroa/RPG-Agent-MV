...
test('hostile main-menu acceptance controls expose stable semantic selectors', () => {
  ...
  const exportSurface = compile('./UiDesignerExportSurface.vue')
  ...
  assert.match(toolbar, /designer\.save\('saveAs'\)/)
  assert.match(toolbar, /publishToProject/)
  assert.doesNotMatch(shell, /shortcutSaveAs/)
  assert.match(shell, /ui-designer-conflict-save-as/)
  assert.match(shell, /resolveFileConflict\('saveAs'\)/)
  ...
  assert.match(exportSurface, /advancedExport/)
  assert.match(exportSurface, /designFileHint/)
  assert.match(exportSurface, /applyProjectChanges/)
  assert.match(exportSurface, /ui-designer-review-staged/)
  assert.match(shell, /runtimeInstallPromptTitle/)
  assert.match(shell, /rawDesigner\.checkRuntime\(\)/)
  assert.match(shell, /:apply-project-changes="props\.applyProjectChanges"/)
